...
import 'package:untitled1/screens/image_ai//preview_screen.dart';

class CameraScanTextAI extends StatefulWidget {
  const CameraScanTextAI({Key? key}) : super(key: key);

  @override
  State<CameraScanTextAI> createState() => _CameraScanTextAIState();
}

class _CameraScanTextAIState extends State<CameraScanTextAI> {
